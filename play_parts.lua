-- Play "Lahai-Roi JAZZ" (CC:Tweaked DFPWM) by streaming it in parts, looping forever.
--
-- The track is split into 512 KiB parts of one continuous DFPWM stream
-- (part01.dfpwm .. part34.dfpwm). Each part is downloaded, played, and - if
...
-- =========================== hardcoded config ===========================
local BASE = "https://github.com/Igidn/cc-audio/releases/download/v2/"
local PARTS = 34
local TOTAL_BYTES = 17764868 -- only used to decide whether caching is worth it
